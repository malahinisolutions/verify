...
INSERT INTO `City` VALUES (3679,'Novotcherkassk','RUS','Rostov-na-Donu',184400);
...
INSERT INTO `Country` VALUES ('CIV','Cote d’Ivoire','Africa','Western Africa',322463.00,1960,14786000,45.2,11345.00,10285.00,'Côte d’Ivoire','Republic','Laurent Gbagbo',2814,'CI');
...
INSERT INTO `Country` VALUES ('REU','Reunion','Africa','Eastern Africa',2510.00,NULL,699000,72.7,8287.00,7988.00,'Réunion','Overseas Department of France','Jacques Chirac',3017,'RE');
...
-- Rename table
RENAME TABLE `CountryLanguage` TO `country_languages`;